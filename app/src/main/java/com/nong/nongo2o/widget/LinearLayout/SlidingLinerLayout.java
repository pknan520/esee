...
public class SlidingLinerLayout extends LinearLayout {
    private float yFraction = 0;
    private float xFraction = 0;


    public SlidingLinerLayout(Context context) {
        super(context);
    }

    public SlidingLinerLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public SlidingLinerLayout(Context context, AttributeSet attrs, int defStyle) {
